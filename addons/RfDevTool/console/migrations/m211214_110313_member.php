...
class m211214_110313_member extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%member}}', [
            ...
            'merchant_id' => "int unsigned NULL DEFAULT '0' COMMENT '商户id'",
            ...
            'current_level' => "tinyint NULL DEFAULT '1' COMMENT '当前级别'",
            ...
            'visit_count' => "int unsigned NULL DEFAULT '1' COMMENT '访问次数'",
            'home_phone' => "varchar(20) NULL DEFAULT '' COMMENT '家庭号码'",
            'mobile' => "varchar(20) NULL DEFAULT '' COMMENT '手机号码'",
            'role' => "smallint NULL DEFAULT '10' COMMENT '权限'",
            'last_time' => "int NULL DEFAULT '0' COMMENT '最后一次登录时间'",
            'last_ip' => "varchar(16) NULL DEFAULT '' COMMENT '最后一次登录ip'",
            'province_id' => "int NULL DEFAULT '0' COMMENT '省'",
            'city_id' => "int NULL DEFAULT '0' COMMENT '城市'",
            'area_id' => "int NULL DEFAULT '0' COMMENT '地区'",
            'pid' => "int unsigned NULL DEFAULT '0' COMMENT '上级id'",
            'level' => "tinyint unsigned NULL DEFAULT '1' COMMENT '级别'",
            'promo_code' => "varchar(50) NULL DEFAULT '' COMMENT '推广码'",
            'tree' => "varchar(750) NOT NULL DEFAULT '' COMMENT '树'",
            'status' => "tinyint NULL DEFAULT '1' COMMENT '状态[-1:删除;0:禁用;1启用]'",
            'created_at' => "int unsigned NULL DEFAULT '0' COMMENT '创建时间'",
            'updated_at' => "int unsigned NULL DEFAULT '0' COMMENT '修改时间'",
            'PRIMARY KEY (`id`)'
